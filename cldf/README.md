...
[dc:extent](http://purl.org/dc/terms/extent) | 745607
...
[dc:extent](http://purl.org/dc/terms/extent) | 1445
...
[dc:extent](http://purl.org/dc/terms/extent) | 125960
...
property | value
 --- | ---
[dc:conformsTo](http://purl.org/dc/terms/conformsTo) | [CLDF ParameterTable](http://cldf.clld.org/v1.0/terms.rdf#ParameterTable)
[dc:extent](http://purl.org/dc/terms/extent) | 38730
...
`Variety_Weight` | `string` | 
`Language_Weight` | `string` | 
...
`Missing_Data` | list of `string` (separated by ` `) | 
